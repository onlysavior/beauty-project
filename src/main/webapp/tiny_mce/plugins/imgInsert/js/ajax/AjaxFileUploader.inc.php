...
class AjaxFileuploader {
	...
	public function showFileUploader($uploaderId) {
		if (in_array($uploaderId, $this->uploaderIdArray)) {
			...
			return '<form id="formName'.$uploaderId.'" method="post" enctype="multipart/form-data" action="js/ajax/imageupload.php?dirname='.$this->uploadDirectory.'" target="iframe'.$uploaderId.'">
						...
						<iframe name="iframe'.$uploaderId.'" src="js/ajax/imageupload.php" width="400" height="100" style="display:none"> </iframe>
					</form>';
		}
	}
}
