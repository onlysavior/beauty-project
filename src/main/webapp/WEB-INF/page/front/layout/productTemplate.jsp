...
<div id='top' style='width:990px;height:365px;background:none transparent scroll repeat 0% 0%'>
    ...
    <div id='pdv_5052' class='pdv_class'  title='' style='width:990px;height:320px;top:43px;left:0px; z-index:1'>
    ...
    <div id='pdv_5054' class='pdv_class'   style='width:976px;height:306px;top:44px;left:0px; z-index:2'>
        <div id='spdv_5054' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
            <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
                <div style="height:25px;margin:1px;display:none;background:;">
                    <div style="float:left;margin-left:12px;line-height:25px;font-weight:bold;color:">
    ...
    <div id='pdv_5050' class='pdv_class'  title='' style='width:285px;height:86px;top:73px;left:66px; z-index:4'>
    ...
    <div id='pdv_5055' class='pdv_class'   style='width:656px;height:59px;top:0px;left:0px; z-index:9'>
...
<div id='content' style='width:990px;height:599px;background:#ffffff;margin:0px auto'>
...
<div id='bottom' style='width:990px;height:42px;background:url(<c:url value='/effect/source/bg/x09.jpg'/>) #000000'>
    <!-- 底部信息编辑区 -->
    <div id='pdv_5056' class='pdv_class'  title='脚注信息' style='width:306px;height:23px;top:15px;left:594px; z-index:6'>
    ...
    <div id='pdv_5053' class='pdv_class'   style='width:331px;height:33px;top:7px;left:0px; z-index:7'>
        <div id='spdv_5053' class='pdv_bottom' style='overflow:hidden;width:100%;height:100%'>
            <!--bottomlink-->
