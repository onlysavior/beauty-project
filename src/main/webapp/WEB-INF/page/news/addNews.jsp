    ...
    <script type="text/javascript">
       $(document).ready(function(){
           tinyMCE.init({
               ...
               // Theme options
               theme_advanced_buttons1 : "insertAttachment,insertImg,，example,imgInsert,save,newdocument,|,bold,italic,underline,strikethrough,|,justifyleft,justifycenter,justifyright,justifyfull,|,styleselect,formatselect,fontselect,fontsizeselect",
 ...
 <div class="row-fluid ">
 	<div class="span3 bs-docs-sidebar" >  
 		<ul class="nav nav-list bs-docs-sidenav">
	      ...
	      <li class="active"><a href="${website}backend/addNews"><i class="icon-chevron-right"></i>添加新闻 </a></li>
		</ul>
 	</div>
 	<div class="span9">
